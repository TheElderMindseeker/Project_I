...
public:
     ...
     *
     * Constructs Date object equivalent to Date ("01.01.0001")
     *
     * @note It is not recommended to use this constructor to make 01.01.0001 date.
     * It is better to construct that date explicitly.
     */
    Date ();
    ...
    /**
     * @brief Sets day in month for the current date.
     *
     * @param day Day in month.
     *
     * @throw invalid_argument If the resulting date is not valid.
     */
    void set_day (int day) throw (std::invalid_argument);

    /**
     * @brief Sets month in year for the current date.
     *
     * @param month Month in year.
     *
     * @throw invalid_argument If the resulting date is not valid.
     */
    void set_month (int month) throw (std::invalid_argument);

    /**
     * @brief Sets year A.D. for the current date.
     *
     * @param year Year A.D.
     *
     * @throw invalid_argument If the resulting date is not valid.
     */
    void set_year (int year) throw (std::invalid_argument);
